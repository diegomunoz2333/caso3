...
### Dimensión de salud y bienestar
...
### Dimensión ambiental y de recursos
...
La inclusión de variables demográficas es justificada porque la dinámica poblacional condiciona fundamentalmente los desafíos y oportunidades de desarrollo, como la presión sobre recursos, el mercado laboral, la demanda por servicios públicos, y la sostenibilidad fiscal (CEPAL, 2023; World Bank, 2023). Países con crecimiento poblacional acelerado enfrentan distintos desafíos que aquellos con envejecimiento poblacional, impactando tasas de ahorro, inversión, y provisión de servicios (CEPAL, 2023), vemos las variables en la tabla 5.
...
A continuación, se muestra la base de datos que se usará para el modelo de aprendizaje no supervisado.
...
En la dimensión 3, Malta emerge como el mayor contribuidor con 19.43%, posicionándose en el extremo positivo del eje que representa economías hiperglobalizadas con ratios comerciales excesivamente altos, reflejando su condición de centro financiero y comercial con flujos internacionales que superan significativamente su PIB. China contribuye con 5.18% en el extremo negativo, evidenciando una estructura comercial más balanceada basada en exportaciones de manufactura y sostenida por una vasta base poblacional. En la dimensión 4, India con 18.65% se coloca en el extremo negativo, reflejando presión demográfica extrema sobre recursos naturales (1,400 millones de habitantes sobre territorio limitado generan demanda exponencial de tierra cultivable y agua). Timor-Leste aporta 8.49% en el extremo positivo, caracterizándose por baja densidad poblacional relativa y abundancia de cobertura forestal.
...
En la dimensión 1, la Esperanza de vida lidera con 17.06% de contribución, posicionándose en el extremo positivo, consolidando un eje que representa desarrollo humano y calidad de vida. Simultáneamente, la Mortalidad infantil aporta 16.67% en el extremo negativo (coordenada -0.907), estableciendo un contraste fundamental, naciones con alta esperanza de vida versus aquellas con elevada mortalidad neonatal refleja de sistemas de salud deficitarios. En la dimensión 2, la Industria en el extremo negativo con 26.48% de contribución, refleja economías donde la dependencia de una única rama industrial es REDUCIDA o donde la manufactura está integrada verticalmente de manera autónoma. Las Remesas emergen como segundo vector importante con 12.0% en el extremo positivo, capturando economías ALTAMENTE DEPENDIENTES de transferencias de capital internacional, caracterizadas por débil base productiva propia y vulnerabilidad a ciclos externos.
...
En la dimensión 3, las variables comerciales revelan un eje fundamental de integración global. Las Importaciones (26.78%), Exportaciones (26.43%) e Inversión extranjera (13.2%) contribuyen NEGATIVAMENTE, indicando que el polo negativo representa economías CERRADAS con baja intensidad comercial —limitadas importaciones, reducidas exportaciones y escasa inversión externa—. El polo positivo representa el extremo opuesto: economías ALTAMENTE ABIERTAS con flujos comerciales exponenciados e inversión transnacional abundante, donde las importaciones, exportaciones e inversión alcanzan valores máximos. Transitando hacia la dimensión 4, el patrón codifica la dicotomía fundamental entre presión territorial extrema y disponibilidad de recursos naturales. El Área boscosa contribuye NEGATIVAMENTE (29.47%), revelando que el polo negativo representa deforestación severa —contextos donde bosques han sido masivamente convertidos en tierra cultivable—. En contraste, el polo positivo agrupa variables de abundancia: Tierra cultivable (26.32%) y Población (19.51%) contribuyen POSITIVAMENTE, identificando contextos donde existe equilibrio entre población y recursos territoriales, caracterizados por alta disponibilidad de tierra cultivable y población sin presión deforestadora extrema. Esta dimensión captura así la tensión fundamental entre sistemas ecológicos deteriorados por sobrepresión demográfica versus territorios donde recursos naturales se mantienen relativamente conservados
...
La selección del número óptimo de clusters k se realizó mediante la evaluación conjunta de tres criterios complementarios, el análisis del dendrograma, el método del codo, y la coherencia interpretativa. El dendrograma revela visualmente la estructura jerárquica de fusiones, permitiendo identificar alturas donde las fusiones producen incrementos dramáticos en disimilaridad, sugiriendo cu´laes clusters diferenciados se están uniendo. Un corte horizontal del dendrograma a altura intermedia permite definir el número de clusters finales.
...
Explica casi un cuarto de toda la variabilidad en desarrollo internacional, capturando la dimensión más fundamental que diferencia a países ricos de pobres. Se define por esperanza de vida (0.413), uso de internet (0.4126), acceso a electricidad (0.3709) contrapuestos a mortalidad infantil (-0.4083). Estas variables covarían porque todas requieren sistemas de salud consolidados, riqueza económica, infraestructura tecnológica y estabilidad política, es decir, reflejan la capacidad institucional de una sociedad para garantizar bienestar multidimensional. Países que han logrado esperanzas de vida de 80+ años han realizado décadas de inversión en salud pública, educación universal y desarrollo económico; simultáneamente, estos mismos países inevitablemente desarrollaron infraestructuras digitales avanzadas porque sus economías postindustriales dependen de servicios e innovación tecnológica.
