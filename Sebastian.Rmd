...
p3 <- plot_ly(ind_df,
              ...
              text = ~paste("<b>", Pais, "</b><br>",
                            ...
                            "<b>Contribución Dim 3:</b> ", round(Contrib5, 2), "%<br>",
                            "<b>Contribución Dim 4:</b> ", round(Contrib6, 2), "%<br>",
  ...
  layout(
    title = list(
      text = "Individuos: Dimensión 5 vs Dimensión 6<br><sub>Coloreado por Contribución Dim 6</sub>",
      font = list(size = 16, color = "#2C5F8D")
    ),
...
```{r Paises y variables DIM 5 Y DIM 6}
p3 <- plot_ly() %>%
