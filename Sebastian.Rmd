...
res.pca$coord          # Coordinates
res.var$contrib        # Contributions to the PCs
res.var$cos2  
View(res.var$contrib[,1:7])
...
```
El país Senegal y Burkina Faso van en la misma dirección que la mortalidad infantil.
El país egipto va en la misma dirección que la variable crecimiento poblacional.
El país Botswana va en la misma dirección que la variable población
El país Argelia e Iraq van en la misma dirección que la variable Crecimiento PIB.
El país federeción Rusa y Australia van en la misma dirección de la variable Suscripciones móvil.
El país Vietnam va en la misma dirección que la variable PIB_per.
No hay país que vaya en la misma dirección que la vairable uso de internet.
El país Korea, Rep y New Zealand va en la misma dirección que la variable Exportaciones.
El país Switzerland va en la misma dirección que la variable Esperanza de vida.
El país Swiden y United Kingdom va en la misma dirección que la variable Acceso electricidad.
El país Mauritius y Tunisia va en la misma dirección que la variable Inversión estranjera.
El país Bulgaria y North Macedonia va en la misma dirección que la variable Gasto Salud.
El país Bosnia y Serbia and Herzegovina va en la misma dirección que la variable Importaciones.
El país Moldoba va en la misma dirección que la variable Area boscosa.
El país Switzerland va en la misma dirección que la variable Tierra Esperanza vida
El país Kyrgiz Republic y Honduras va en la misma dirección que la variable Remesas.
El país Marshall Islands va en la misma dirección que la variable Tierra cultivable.
...
p2
```
El país Guinea va en la misma dirección que la variable Crecimiento poblacional.
El país Kuwait y Djibouti va en la misma dirección que la variable Importaciones.
El país Senegal y Ireland va en la misma dirección que la variable Exportaciones.
El país Burkina Faso y Qatar va en la misma dirección que la variable Mortalidad infantil.
El país North Macedonia va en la misma dirección que la variable PIB_per
