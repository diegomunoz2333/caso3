...
htmltools::tagList(
  htmltools::HTML(
    '<div style="
      ...
      letter-spacing: 2px;
    ">
       Figura 6: Distribución Geoespacial de Indicadores de Desarrollo Global 2022
    </div>'
  ),
  mapa
)
...
heatmap_interactivo <- plot_ly(
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:20px;'>Figura 7: Matriz de Correlaciones Multidimensional</b><br>
...
g <- ggplot(eig_df, aes(x = Componente, y = Varianza)) +
  ...
  theme_cyber() +
  labs(
    title = "Figura 8: Varianza Explicada por Componente Principal",
...
p1 <- plot_ly(ind_df,
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:20px;'>Figura 9: Análisis de Componentes Principales</b><br>
...
p1 <- plot_ly(var_df,
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:20px;'>Figura 11: Variables-Dimensión 1 vs Dimensión 2</b><br>
...
p2 <- plot_ly(var_df,
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:20px;'>Figura 12: Variables-Dimensión 3 vs Dimensión 4</b><br>
...
p1 <- plot_ly() %>%
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:22px;'>Figura 13: Biplot-Dimensión 1 vs Dimensión 2</b><br>
...
p2 <- plot_ly() %>%
  ...
  layout(
    title = list(
      text = "<b style='color:#00e5ff; font-size:22px;'>Figura 14: Biplot-Dimensión 3 vs Dimensión 4</b><br>
             <span style='color:#8b92a0; font-size:13px;'></span>",
      x = 0.5,
      xanchor = 'center',
      y = 0.98
